...
### ㅇ프로젝트 개요 
- 현재 운영중인 '왓챠플레이어' 를 기반하여 독학으로 ReactJS를 사용하여 HTML,CSS,Javascript 직접 제작하여 만들었습니다.
  매주 업데이트 되는 영화를 장르별로 볼 수 있도록 구현하였습니다.
...
- 영화를 클릭하면 모달창이 떠서 영화에 대한 상세한 정보를 볼 수 있습니다.
  (Movie api에서 video는 제공 해주지 않아서 플레이 실행이 안 되는 점 양해 부탁드립니다.)
